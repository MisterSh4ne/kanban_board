<template>
  <div>
      <div v-for="project_item in projects" 
      :key="project_item.id" 
      class="list-item-project" 
      @click="open_project(project_item.id)">
        <div class="container-item">
          <div class="center-vertical name-project-text">{{ project_item.name }}</div>
        </div>
        <div class="container-item">
          <div class="center-vertical">
            <div style="font-weight: bold">Created at</div>
          <div>{{ show_created_at(project_item.created_at) }}</div>
          </div>
        </div>
        <div class="container-item">
          <div class="center-vertical">
...
export default {
  ...
  methods:{
    show_created_at(created_at){
      return moment(created_at, "YYYY-MM-DD HH:mm:ss").format("MMM DD YYYY HH:mm:ss")
    },
